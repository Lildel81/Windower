...
function init_gear_sets()
    ...
    sets.TreasureHunter = {
        head="Volte Cap",--1
    body="Volte Jupon",--2
    hands={ name="Plun. Armlets +1", augments={'Enhances "Perfect Dodge" effect',}},--4
    ...
    body={ name="Herculean Vest", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','Crit.hit rate+1','"Mag.Atk.Bns."+13',}},
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+25','"Dbl.Atk."+1','STR+9','"Mag.Atk.Bns."+15',}},
