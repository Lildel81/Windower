...
function init_gear_sets()
    ...
    feet="Meg. Jam. +2",
    waist="Yemaya Belt",
    back={ name="Camulus's Mantle", augments={'"Snapshot"+10',}}, --0/20
        }) --47/52
    ...
    sets.engaged.DW.LowAcc.HighHaste = set_combine(sets.engaged.DW.HighHaste, {head="Malignance Chapeau",
    body={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    hands={ name="Gazu Bracelet +1", augments={'Path: A',}},
    legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}},
    feet="Malignance Boots",
    ...
    sets.engaged.DW.MidAcc.HighHaste = set_combine(sets.engaged.DW.LowAcc.HighHaste, {head="Malignance Chapeau",
    body={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    hands={ name="Gazu Bracelet +1", augments={'Path: A',}},
    legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}},
    feet="Malignance Boots",
    ...
    sets.engaged.DW.HighAcc.HighHaste = set_combine(sets.engaged.DW.MidAcc.HighHaste, {head="Malignance Chapeau",
    body={ name="Adhemar Jacket +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    hands={ name="Gazu Bracelet +1", augments={'Path: A',}},
    legs={ name="Carmine Cuisses +1", augments={'Accuracy+20','Attack+12','"Dual Wield"+6',}},
    feet="Malignance Boots",
    ...
    sets.engaged.Hybrid = {
        ...
        body="Meghanada Cuirie +2", --9/9
        hands="Malignance Gloves", --5/5
        legs="Meghanada Chausses +2", --7/7
    ...
    sets.DeathPenalty_M = {main="Naegling",sub={ name="Demers. Degen +1", augments={'Path: A',}},range="Death Penalty",}
    sets.DeathPenalty_M.Acc = {main="Tauret",sub={ name="Demers. Degen +1", augments={'Path: A',}},range="Death Penalty",}
    sets.DeathPenalty_R = { main={ name="Rostam", augments={'Path: C',}},sub="Lanun Knife",range={ name="Death Penalty", augments={'Path: A',}},}
    ...
    sets.Fomalhaut_M = {main="Naegling",sub={ name="Demers. Degen +1", augments={'Path: A',}},range="Fomalhaut",}
    sets.Fomalhaut_M.Acc = {main="Naegling",sub={ name="Demers. Degen +1", augments={'Path: A',}},range="Fomalhaut",}
