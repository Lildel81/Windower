...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set','Sakpata', 'Maxentius', 'Naegling', 'Nuking'}
...
function init_gear_sets()
    ...
    sets.Sakpata = {main="Sakpata's Sword",sub="Naegling",}
    sets.Naegling = {main="Naegling", sub="Sakpata's Sword"}
