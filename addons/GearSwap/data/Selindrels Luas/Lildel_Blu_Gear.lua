...
include('organizer-lib')
	...
	send_command('bind ^pageup input /item "Smouldering Lamp" <stnpc>')
	send_command('bind %numpad1 input //fillmode 1')
	send_command('bind %numpad2 input //fillmode 0')
	send_command('!^r return input //sw po all return')
	send_command('!^a assault input //sw po all assault')
	send_command('%numpad3 input //send Picodelgallo /boltersroll')
...
function init_gear_sets()
	...
	sets.buff.Enchainment = { body={ name="Luhlaza Jubbah", augments={'Enhances "Enchainment" effect',}},}
	...
	sets.precast.WS.SomeAcc = {ammo="Mantoptera Eye",
    head={ name="Adhemar Bonnet", augments={'DEX+10','AGI+10','Accuracy+15',}},
	...
	sets.precast.WS.Fodder = {ammo="Mantoptera Eye",
    head={ name="Adhemar Bonnet", augments={'DEX+10','AGI+10','Accuracy+15',}},
    body={ name="Herculean Vest", augments={'Weapon skill damage +4%','DEX+10','Attack+10',}},
    hands="Jhakri Cuffs +2",
    legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}},
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ammo="Falcon Eye",
    ...
    right_ring="Karieyh Ring",
    back={ name="Cornflower Cape", augments={'MP+18','DEX+2','Accuracy+1','Blue Magic skill +6',}},})
	sets.precast.WS['Requiescat'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
    ...
    right_ring="Karieyh Ring",
    back={ name="Cornflower Cape", augments={'MP+18','DEX+2','Accuracy+1','Blue Magic skill +6',}},})
	sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
    ...
    right_ring="Karieyh Ring",
    back={ name="Cornflower Cape", augments={'MP+18','DEX+2','Accuracy+1','Blue Magic skill +6',}},})
	sets.precast.WS['Requiescat'].HighAcc = set_combine(sets.precast.WS.HighAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
    ...
    right_ring="Karieyh Ring",
    back={ name="Cornflower Cape", augments={'MP+18','DEX+2','Accuracy+1','Blue Magic skill +6',}},})
	sets.precast.WS['Requiescat'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
    ...
    right_ring="Karieyh Ring",
    back={ name="Cornflower Cape", augments={'MP+18','DEX+2','Accuracy+1','Blue Magic skill +6',}},})
	sets.precast.WS['Requiescat'].Fodder = set_combine(sets.precast.WS['Requiescat'], {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'] = set_combine(sets.precast.WS, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'].HighAcc = set_combine(sets.precast.WS.HighAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.precast.WS['Realmrazer'].Fodder = set_combine(sets.precast.WS['Realmrazer'], {ammo="Falcon Eye",
    head="Jhakri Coronal +2",
    body="Jhakri Robe +2",
    hands="Jhakri Cuffs +2",
    legs="Jhakri Slops +2",
	...
	sets.midcast['Blue Magic'].Physical = {main="Vampirism",sub="Vampirism",ammo="Mavi Tathlum",
		...
		back=gear.wsd_jse_back,waist="Orpheus's Sash",legs="Jhakri Slops +2",feet=gear.herculean_acc_feet}
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Sequence",sub="Colada",ammo="Falcon Eye",
	    ...
	    body="Assim. Jubbah +3",hands="Assim. Bazu. +3",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	    back=gear.da_jse_back,waist="Orpheus's Sash",legs="Jhakri Slops +2",feet=gear.herculean_acc_feet}
	...
	sets.midcast['Elemental Magic'] = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Dosis Tathlum",
					 head="Jhakri Coronal +2",neck="Baetyl Pendant",ear1="Regal Earring",ear2="Friomisi Earring",
					 body="Jhakri Robe +2",hands="Amalric Gages +1",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
				     back=gear.mab_jse_back,waist="Orpheus's Sash",legs="Hagondes Pants +1",feet="Jhakri Pigaches +2"}
	...
	-- Weapons sets
	sets.weapons.Tizalmace = { main="Sakpata's Sword",sub="Naegling",}
	...
	sets.weapons.MagicWeapons = {main="Sakpata's Sword",sub="Kaja Rod"}
