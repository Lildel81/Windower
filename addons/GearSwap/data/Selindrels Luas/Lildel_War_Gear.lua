function user_job_setup()
	...
	state.Weapons:options('Chango','Polearm','Greatsword','Axe','Sword','DualWeapons','Club','ProcDagger','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana','ProcClub','ProcStaff')
...
function init_gear_sets()
    ...
    sets.precast.WS['Savage Blade'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Pumm. Lorica +2",
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
    legs="Pumm. Cuisses +2",
	...
	sets.precast.WS['Black Halo'].SomeAcc = {}
	
	sets.precast.WS['Black Halo'].Acc = {}
	
	sets.precast.WS['Black Halo'].FullAcc = {}
	
	sets.precast.WS['Black Halo'].Fodder = {}

    sets.precast.WS['Upheaval'] = set_combine(sets.precast.WS, {ammo="Coiste Bodhar",
    head="Flam. Zucchetto +2",
    ...
    sets.precast.WS['Upheaval'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Coiste Bodhar",
    head="Flam. Zucchetto +2",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Upheaval'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Pumm. Lorica +2",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
    ...
    sets.precast.WS['Upheaval'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Knobkierrie",
    head="Sakpata's Helm",
    body="Pumm. Lorica +2",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
    ...
    sets.precast.WS['Resolution'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Coiste Bodhar",
    head="Flam. Zucchetto +2",
    body="Pumm. Lorica +2",
    hands="Sulev. Gauntlets +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Ruinator'] = set_combine(sets.precast.WS, {ammo="Coiste Bodhar",
    head="Flam. Zucchetto +2",
    body="Sakpata's Plate",
    hands="Sulev. Gauntlets +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Ruinator'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Coiste Bodhar",
    head="Flam. Zucchetto +2",
    body="Sakpata's Plate",
    hands="Sulev. Gauntlets +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Ruinator'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Seeth. Bomblet +1",
    head="Flam. Zucchetto +2",
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Ruinator'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Seeth. Bomblet +1",
    head="Flam. Zucchetto +2",
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Rampage'] = set_combine(sets.precast.WS, {ammo="Yetshila",
    ...
    sets.precast.WS['Rampage'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Rampage'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Rampage'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
	...
	sets.precast.WS['Decimation'].SomeAcc = {ammo="Aurgelmir Orb +1",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
	...
	sets.precast.WS['Decimation'].Acc = {ammo="Aurgelmir Orb +1",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
	...
	sets.precast.WS['Decimation'].FullAcc = {ammo="Aurgelmir Orb +1",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
	...
	sets.precast.WS['Decimation'].Fodder = {ammo="Aurgelmir Orb +1",
    head="Sakpata's Helm",
    body="Sakpata's Plate",
    hands="Sakpata's Gauntlets",
    legs="Sakpata's Cuisses",
	...
	sets.precast.WS['Cloudsplitter'] = {main="Dolichenus",
    sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+13','Accuracy+8','Attack+12',}},
	...
	sets.precast.WS['Cloudsplitter'].SomeAcc = {main="Dolichenus",
    sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+13','Accuracy+8','Attack+12',}},
    ammo="Seeth. Bomblet +1",
    head="Nyame Helm",
    body="Nyame Mail",
	...
	sets.precast.WS['Cloudsplitter'].Acc = {main="Dolichenus",
    sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+13','Accuracy+8','Attack+12',}},
    ammo="Seeth. Bomblet +1",
    head="Nyame Helm",
    body="Nyame Mail",
	...
	sets.precast.WS['Cloudsplitter'].FullAcc = {main="Dolichenus",
    sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+13','Accuracy+8','Attack+12',}},
    ammo="Seeth. Bomblet +1",
    head="Nyame Helm",
    body="Nyame Mail",
	...
	sets.precast.WS['Cloudsplitter'].Fodder = {main="Dolichenus",
    sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+13','Accuracy+8','Attack+12',}},
    ammo="Seeth. Bomblet +1",
    head="Nyame Helm",
    body="Nyame Mail",
    ...
    sets.precast.WS['Raging Rush'] = set_combine(sets.precast.WS, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Jokushu Haidate",
    ...
    sets.precast.WS['Raging Rush'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Jokushu Haidate",
    ...
    sets.precast.WS['Raging Rush'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.precast.WS['Raging Rush'].FullAcc = set_combine(sets.precast.WS.FullAcc, {ammo="Yetshila",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body="Pumm. Lorica +2",
    hands="Pumm. Mufflers +2",
    legs="Pumm. Cuisses +2",
    ...
    sets.engaged.FullAcc = {ammo="Seeth. Bomblet +1",
    head="Flam. Zucchetto +2",
    body="Sakpata's Plate",
    hands="Sulev. Gauntlets +2",
    legs="Pumm. Cuisses +2",
...
-- Ragnarok melee sets
	...
	-- Weapons sets
	sets.weapons.Chango = {main="Jokushuono",sub="Utu Grip",}
	sets.weapons.Polearm = {main = "Shining One", sub = "Utu Grip"}
	sets.weapons.DualWeapons = {main="Dolichenus",sub="Firangi",}
