...
function init_gear_sets()
    ...
    body="Shango Robe",
    hands={ name="Kaykaus Cuffs +1", augments={'MP+80','MND+12','Mag. Acc.+20',}},
    legs={ name="Merlinic Shalwar", augments={'Enmity+2','MND+5','Magic burst dmg.+6%','Accuracy+8 Attack+8','Mag. Acc.+5 "Mag.Atk.Bns."+5',}},
    feet="Mallquis Clogs",
    neck="Erra Pendant",
    left_ring="Stikini Ring +1",
    right_ring="Stikini Ring",
    ...
    sets.midcast.Drain = set_combine(sets.midcast['Dark Magic'], {
        main={ name="Akademos", augments={'INT+15','"Mag.Atk.Bns."+15','Mag. Acc.+15',}},
    ammo="Floestone",
    head={ name="Merlinic Hood", augments={'"Drain" and "Aspir" potency +3','INT+7','"Mag.Atk.Bns."+11',}},
    body="Shango Robe",
    hands={ name="Kaykaus Cuffs +1", augments={'MP+80','MND+12','Mag. Acc.+20',}},
    legs={ name="Merlinic Shalwar", augments={'Enmity+2','MND+5','Magic burst dmg.+6%','Accuracy+8 Attack+8','Mag. Acc.+5 "Mag.Atk.Bns."+5',}},
    feet="Mallquis Clogs",
