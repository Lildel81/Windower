...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'Aeneas', 'Blurred', 'Tauret', 'Naegling'}
...
function init_gear_sets()
    ...
    sets.precast.FC = {
        main={ name="Grioavolr", augments={'"Fast Cast"+5','MND+5','"Mag.Atk.Bns."+12',}},
    ...
    sets.Aeneas = {main={ name="Aeneas", augments={'Path: A',}},sub="Gleti's Knife",}
    sets.Blurred = {main={ name="Aeneas", augments={'Path: A',}},sub="Blurred Knife +1",}
    sets.Tauret = {main="Tauret", sub="Blurred Knife +1",}
    sets.Naegling = {main="Naegling", sub={ name="Demers. Degen +1", augments={'Path: A',}},}
