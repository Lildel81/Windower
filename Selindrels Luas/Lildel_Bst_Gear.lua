function user_job_setup()
	...
	state.Weapons:options('None','PetOnly','Sword','Axes','Fencer','Blunt')
	...
	state.JugMode = M{['description']='Jug Mode','GenerousArthur', 'BouncingBertha','BlackbeardRandy','AcuexFamiliar','VivaciousVickie','SwoopingZhivago','RhymingShizuna','PonderingPeter',
	'FleetReinhard','AnklebiterJedd','WarlikePatrick','AgedAngus',}
...
function init_gear_sets()
	...
	sets.precast.Waltz['Healing Waltz'] = {}
		...
		-- STEPS
	sets.precast.Step = {head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands="Malignance Gloves",
	...
	sets.precast.Flourish1['Violent Flourish'] = {head="Rabid Visor",
    body="Emet Harness +1",
    hands="Malignance Gloves",
	...
	sets.precast.FC = {body={ name="Taeon Tabard", augments={'Spell interruption rate down -10%','Phalanx +3',}},
    ...
    back={ name="Artio's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+5','"Dbl.Atk."+10',}},})
	
	sets.precast.WS['Ruinator'].Mekira = set_combine(sets.precast.WS['Ruinator'], {head="Gavialis Helm"})
	sets.precast.WS['Ruinator'].WSMidAcc = set_combine(sets.precast.WS.WSMidAcc, {ammo="Coiste Bodhar",
    head="Skormoth Mask",
    body="Tali'ah Manteel +2",
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
	...
	sets.precast.WS['Ruinator'].WSHighAcc = set_combine(sets.precast.WS.WSHighAcc, {ammo="Coiste Bodhar",
    head="Skormoth Mask",
    body="Tali'ah Manteel +2",
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
	...
	sets.precast.WS['Decimation'].WSMidAcc={ammo="Coiste Bodhar",
    head="Skormoth Mask",
    body="Tali'ah Manteel +2",
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
	...
	sets.precast.WS['Decimation'].WSHighAcc = {ammo="Coiste Bodhar",
    head="Skormoth Mask",
    body="Tali'ah Manteel +2",
    hands="Meg. Gloves +2",
    legs="Meg. Chausses +2",
	...
	sets.precast.WS['Savage Blade'].WSMidAcc = {ammo="Aurgelmir Orb +1",
    head={ name="Ankusa Helm +3", augments={'Enhances "Killer Instinct" effect',}},
    body={ name="Valorous Mail", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Weapon skill damage +4%','Accuracy+14 Attack+14',}},
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
    legs="Nyame Flanchard",
	...
	sets.precast.WS['Savage Blade'].WSHighAcc = {ammo="Hesperiidae",
    head={ name="Ankusa Helm +3", augments={'Enhances "Killer Instinct" effect',}},
    body={ name="Valorous Mail", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Weapon skill damage +4%','Accuracy+14 Attack+14',}},
    hands={ name="Nyame Gauntlets", augments={'Path: B',}},
    legs="Nyame Flanchard",
    ...
    legs={ name="Valorous Hose", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Dbl.Atk."+1 Pet: Crit.hit rate +1','Pet: INT+4','Pet: Attack+12 Pet: Rng.Atk.+12',}},
    feet={ name="Valorous Greaves", augments={'Accuracy+24','"Dbl.Atk."+4','MND+10',}},
    neck={ name="Bst. Collar +2", augments={'Path: A',}},
	...
	sets.idle.Pet.Engaged.DW = {ammo="Hesperiidae",
    head={ name="Emicho Coronet +1", augments={'Pet: Accuracy+20','Pet: Attack+20','Pet: "Dbl. Atk."+4',}},
    body={ name="Taeon Tabard", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','Pet: "Dbl. Atk."+4','Pet: Damage taken -4%',}},
    hands={ name="Taeon Gloves", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5','Pet: Damage taken -3%',}},
    legs="Tali'ah Sera. +1",
	...
	sets.defense.PetPDT = {ammo="Staunch Tathlum",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands={ name="Ankusa Gloves", augments={'Enhances "Beast Affinity" effect',}},
    legs="Nyame Flanchard",
	...
	sets.defense.PetMDT = {ammo="Staunch Tathlum",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands={ name="Ankusa Gloves", augments={'Enhances "Beast Affinity" effect',}},
    legs="Nyame Flanchard",
	...
	sets.engaged.FullAcc = {ammo="Hesperiidae",
    head={ name="Blistering Sallet +1", augments={'Path: A',}},
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands={ name="Emi. Gauntlets +1", augments={'Accuracy+25','"Dual Wield"+6','Pet: Accuracy+25',}},
    legs="Meg. Chausses +2",
	...
	sets.engaged.SomeAcc.PDT = {ammo="Crepuscular Pebble",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands="Gleti's Gauntlets",
    legs="Jokushu Haidate",
	...
	sets.engaged.Acc.PDT = {ammo="Crepuscular Pebble",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands="Gleti's Gauntlets",
    legs="Jokushu Haidate",
	...
	sets.engaged.FullAcc.PDT = {ammo="Crepuscular Pebble",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands="Gleti's Gauntlets",
    legs="Jokushu Haidate",
	...
	sets.engaged.DW.SomeAcc = {ammo="Aurgelmir Orb +1",
    head="Skormoth Mask",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands={ name="Emi. Gauntlets +1", augments={'Accuracy+25','"Dual Wield"+6','Pet: Accuracy+25',}},
    legs="Meg. Chausses +2",
	...
	sets.engaged.DW.FullAcc = {ammo="Crepuscular Pebble",
    head="Malignance Chapeau",
    body={ name="Gleti's Cuirass", augments={'Path: A',}},
    hands="Gleti's Gauntlets",
    legs="Gleti's Breeches",
	...
	-- Weapons sets
	sets.weapons.PetOnly = {main={ name="Skullrender", augments={'DMG:+15','Pet: Accuracy+20','Pet: Attack+20',}},sub={ name="Skullrender", augments={'DMG:+15','Pet: Accuracy+20','Pet: Attack+20',}},}
	sets.weapons.Sword = {main ="Naegling", sub = "Agwu's Axe",}
	sets.weapons.Axes = {main="Dolichenus",sub={ name="Digirbalag", augments={'"Dbl.Atk."+3','VIT+4','Accuracy+13','Attack+8','DMG:+8',}},}
	sets.weapons.Fencer = {main="Naegling",sub="Adapa Shield",}
