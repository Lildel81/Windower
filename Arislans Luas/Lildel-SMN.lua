...
bp_physical=S{	'Punch','Rock Throw','Barracuda Dive','Claw','Axe Kick','Shock Strike','Camisado','Regal Scratch','Poison Nails',
				...
				'Mountain Buster','Spinning Dive','Predator Claws','Rush','Chaotic Strike','Crag Throw','Volt Strike','Roundhouse','Welt'}

bp_hybrid=S{	'Burning Strike','Flaming Crush','Hysteric Assault',}
...
function set_style(sheet)
    send_command('@input ;wait 5.0;input /lockstyleset 1')
	add_to_chat (21, 'You are so beautiful')
...
send_command(';wait 2.0;equipviewer position 1770 550')
...
function pet_gain()
	...
	if spell.type == 'SummonerPact' and not buffactive['Avatar\'s Favor'] then
		


	send_command ('@input wait 5.0; /ja "Avatar\'s Favor" <me>')
